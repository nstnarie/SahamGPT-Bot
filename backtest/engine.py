...
class BacktestEngine:
    ...
    def run(self, universe_prices, ihsg_df, foreign_flows=None,
        ...
        # Exp 12 throttle removed in v10: fires 14x in 2025 with 44% WR system
        # (P(3 consec losses) = 17.6% — chronically restricts entry capacity)
        ...
        for i, current_date in enumerate(trading_dates):
            ...
            if pending_entries:
                ...
                # v10: throttle removed; use max_entries_per_week directly
